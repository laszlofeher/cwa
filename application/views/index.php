...
<head>
  ...
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?php print(base_url()); ?>/assets/bower_components/bootstrap-daterangepicker/daterangepicker.css">
...
<!-- jQuery Knob Chart -->
<script src="<?php print(base_url()); ?>/assets/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="<?php print(base_url()); ?>/assets/bower_components/moment/min/moment.min.js"></script>
<script src="<?php print(base_url()); ?>/assets/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
